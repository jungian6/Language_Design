...
class Parser:
    ...
    def reverse(self, amount=1):
        """Reverses the current token index"""
        self.tok_idx -= amount
        self.update_current_tok()
        return self.current_tok
    ...
    def factor(self):
        """Performs unary operations and power operations"""
        res = ParseResult()
...
class RTResult:
    ...
    def register(self, res):
        """Register a result from another RTResult """
    ...
    def success(self, value):
        """Register a success value """
        self.reset()
        self.value = value
        return self

    def success_return(self, value):
        """Register a success value and return it """
        self.reset()
        self.func_return_value = value
        return self

    def success_continue(self):
        """Register a success value and continue """
        self.reset()
        self.loop_should_continue = True
        return self

    def success_break(self):
        """Register a success value and break """
        self.reset()
    ...
    def should_return(self):
        """Check if the result should return a value """
        return (
                self.error or
...
class List(Value):
    ...
    def added_to(self, other):
        """Concatenate a list with another list or a number"""
        new_list = self.copy()
...
class Interpreter:
    ...
    def visit_CallNode(self, node, context):
        """ This function is used to call the node."""
        res = RTResult()
        args = []
    ...
    def visit_ReturnNode(self, node, context):
        """ This function is used to return the value of the node."""
        res = RTResult()
